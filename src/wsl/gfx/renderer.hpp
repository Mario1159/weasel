...
/**
 * Base class for graphics renderers.
 *
...
protected:
  /** Creates a 1x1 RGBA8 texture with the specified color. */
  [[nodiscard]] auto create_1x1_texture (uint8_t red, uint8_t green,
                                         uint8_t blue, uint8_t alpha) const
      -> SDL_GPUTexture *;

  /** Creates a 1x1 RGBA8 cubemap with the specified color on all faces. */
