...
/*!
 * \brief Aggregates lists of asset file paths categorized by type.
 */
...
/*!
 * \brief Responsible for creating, loading, and scanning Weasel projects.
 */
...
public:
  ...
  /*!
   * \brief Constructs a project loader.
  ...
  /*!
   * \brief Creates a new project on disk based on the provided configuration.
