...
namespace wsl::gfx {
    /*!
     * \brief Represents a compiled shader module containing its bytecode.
     */
...
namespace wsl::rsc {
    ...
    /*!
     * \brief Resource loader for shader modules.
     *
    ...
    public:
        ...
        /*!
         * \brief Loads a shader module from the specified path.
