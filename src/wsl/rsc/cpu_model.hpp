...
/*!
 * \brief Represents a UV texture coordinate transformation.
 */
struct uv_xform
{
...
/*!
 * \brief Represents a texture stored in system memory.
 */
struct cpu_texture
{
...
/*!
 * \brief Represents a texture slot, combining a texture with an optional transform.
 */
struct cpu_tex_slot
{
...
/*!
 * \brief Represents a material stored in system memory.
 */
struct cpu_material
{
...
/*!
 * \brief Represents a single vertex in a CPU mesh.
 */
struct cpu_vertex
{
...
/*!
 * \brief Represents a geometric primitive within a mesh.
 */
...
/*!
 * \brief Represents a mesh composed of multiple primitives.
 */
struct cpu_mesh
{
...
/*!
 * \brief Represents a node in a scene hierarchy.
 */
struct cpu_node
{
...
/*!
 * \brief Represents a complete 3D model with meshes and scenes.
 */
struct cpu_model
{
